"""V2 / S24 capture-feature validation deck — 2026-08-14, 100 % infill, spray markers.
    ...
    python documentation/v2_capture_plots.py          # plots first
    python documentation/generate_v2_capture_slides.py
...
def img(s, name, x, y, maxw, maxh):
    p = os.path.join("documentation", name)
...
OUT = os.path.join("documentation", "V2_capture_validation.pptx")
prs.save(OUT)
