...
img_fit(s, "documentation/tpu_framing.png", 0.4, 1.28, 12.5, 3.35)
...
img_fit(s, "documentation/tpu_pair.png", 0.4, 1.3, 12.5, 3.5)
...
img_fit(s, "documentation/trio_curves.png", 0.4, 1.3, 12.5, 3.9)
...
img_fit(s, "documentation/trio_modulus.png", 0.35, 1.25, 7.5, 5.0)
...
img_fit(s, "documentation/trio_slopes.png", 0.4, 1.22, 12.5, 4.55)
