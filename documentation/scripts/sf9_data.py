...
figures and print the metric table:
    ...
    python documentation/scripts/sf9_data.py
"""
import os, sys, math, statistics as st

_HERE = os.path.dirname(os.path.abspath(__file__))
_ROOT = os.path.abspath(os.path.join(_HERE, "..", ".."))
_APP = os.path.abspath(os.path.join(_ROOT, "Software", "UTM_PyQt6"))
...
def fig_overview():
    ...
    fig.tight_layout()
    return _save(fig, "documentation/figures/sf9_overview.png")
...
def fig_cyclic():
    ...
    b.legend(fontsize=9)
    fig.tight_layout()
    return _save(fig, "documentation/figures/sf9_cyclic.png")
...
def fig_staircase():
    ...
    b.legend(fontsize=9)
    fig.tight_layout()
    return _save(fig, "documentation/figures/sf9_staircase.png")
...
def fig_relax():
    ...
    fig.tight_layout()
    return _save(fig, "documentation/figures/sf9_relax.png")
...
def fig_creep():
    ...
    fig.tight_layout()
    return _save(fig, "documentation/figures/sf9_creep.png")
...
def fig_t9_baseline():
    ...
    fig.tight_layout()
    return _save(fig, "documentation/figures/sf9_t9_baseline.png")
...
def fig_creep_t9():
    ...
    _note(c, 0.95, 0.16, "same specimen, same minute —\na free relaxation dataset", color=GREEN,
          fs=8.5, ha="right")
    fig.tight_layout()
    return _save(fig, "documentation/figures/sf9_creep_t9.png")
...
def fig_creep_compare():
    ...
    fig.tight_layout()
    return _save(fig, "documentation/figures/sf9_creep_compare.png")
...
def fig_cyclic_t65():
    ...
    c.set_title("Both fall monotonically:\n%.1f → %.1f kJ/m³ · %.2f → %.2f GPa"
                ...
                fontsize=10)
    fig.tight_layout()
    return _save(fig, "documentation/figures/sf9_cyclic_t65.png")
...
def fig_cyclic_compare():
    ...
    fig.tight_layout()
    return _save(fig, "documentation/figures/sf9_cyclic_compare.png")
...
def fig_stair_fracture():
    ...
    fig.tight_layout()
    return _save(fig, "documentation/figures/sf9_stair_fracture.png")
...
def fig_prog_cyclic():
    ...
    fig.tight_layout()
    return _save(fig, "documentation/figures/sf9_prog_cyclic.png")
...
def fig_t7_stall():
    ...
    fig.tight_layout()
    return _save(fig, "documentation/figures/sf9_t7_stall.png")
...
def fig_stress_strain():
    ...
    fig.tight_layout()
    return _save(fig, "documentation/figures/sf9_stress_strain.png")
...
def fig_cyclic_hyst():
    ...
    fig.tight_layout()
    return _save(fig, "documentation/figures/sf9_cyclic_hyst.png")
...
def fig_stair_modulus():
    ...
    fig.tight_layout()
    return _save(fig, "documentation/figures/sf9_stair_modulus.png")
...
def fig_literature():
    ...
    fig.tight_layout()
    return _save(fig, "documentation/figures/sf9_literature.png")
...
def fig_teach_stiffness():
    ...
    c.set_ylim(0, 2700)
    fig.tight_layout()
    return _save(fig, "documentation/figures/sf9_teach_stiffness.png")
...
def fig_strain_terms():
    ...
    fig.tight_layout()
    return _save(fig, "documentation/figures/sf9_strain_terms.png")
...
def fig_true_stress():
    ...
    fig.tight_layout()
    return _save(fig, "documentation/figures/sf9_true_stress.png")
