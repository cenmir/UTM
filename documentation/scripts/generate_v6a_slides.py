...
s.shapes.add_picture("Images/features/preload_schedule.png", Inches(6.75), Inches(1.65), width=Inches(6.2))
...
pic_or_ph(s, "Images/features/DIC HUD UI Screenshot.png", 0.4, 1.35, 8.2, 0.8, "[ drop DIC HUD UI Screenshot.png here ]")
...
s.shapes.add_picture("documentation/figures/feat_dic_halt.png", Inches(0.35), Inches(1.55), width=Inches(7.3))
...
pic_or_ph(s, "Images/features/Settings save_UI_Screenshot.png", 6.95, 1.85, 6.0, 0.6, "[ drop Settings save_UI_Screenshot.png here ]")
...
pic_or_ph(s, "Images/UTM rig/Buckconverter_Enclosure_CAD.png", 0.5, 1.4, 6.3, 5.43, "[ drop Buckconverter_Enclosure_CAD.png here ]")
...
# Every number comes from documentation/scripts/sf9_data.py, which recomputes it from the rig CSVs —
...
UIH = "Software/UTM_PyQt6/ui/help/"
...
tb(s, 0.5, 1.16, 12.4, 0.4,
   ...
   fs=12, italic=True, colour=GREY_TEXT)
img_fit(s, "documentation/figures/sf9_overview.png", 0.45, 1.56, 12.45, 4.45)
...
sf9_result(188, "CYCLIC", "T5 · T6.3", "documentation/figures/sf9_cyclic.png",
...
tb(s, 0.5, 1.14, 12.4, 0.36,
   ...
   fs=11.5, italic=True, colour=GREY_TEXT)
img_fit(s, "documentation/figures/sf9_cyclic_hyst.png", 0.45, 1.50, 12.45, 3.40)
_lag = _ls[1]
...
sf9_result(191, "STAIRCASE", "T3 · T4", "documentation/figures/sf9_staircase.png",
...
tb(s, 0.5, 1.14, 12.4, 0.36,
   ...
   fs=11.5, italic=True, colour=GREY_TEXT)
img_fit(s, "documentation/figures/sf9_stair_modulus.png", 0.45, 1.52, 12.45, 3.45)
...
sf9_result(194, "RELAXATION", "T2", "documentation/figures/sf9_relax.png",
...
sf9_result(196, "CREEP", "T1", "documentation/figures/sf9_creep.png",
...
sf9_result(198, "STAIRCASE → FRACTURE", "T7.2", "documentation/figures/sf9_stair_fracture.png",
...
tb(s, 0.5, 1.16, 12.4, 0.4,
   ...
   fs=12, italic=True, colour=GREY_TEXT)
img_fit(s, "documentation/figures/sf9_t7_stall.png", 0.45, 1.58, 12.45, 3.30)
...
sf9_result(202, "PROGRESSIVE CYCLIC → FRACTURE", "T8", "documentation/figures/sf9_prog_cyclic.png",
...
img_fit(s, "documentation/figures/sf9_teach_stiffness.png", 0.45, 1.52, 12.45, 3.72)
...
img_fit(s, "documentation/figures/sf9_teach_dissipation.png", 0.45, 1.52, 12.45, 3.55)
...
tb(s, 0.5, 1.14, 12.4, 0.36,
   ...
   fs=11.5, italic=True, colour=GREY_TEXT)
img_fit(s, "documentation/figures/sf9_stress_strain.png", 0.45, 1.54, 12.45, 4.55)
...
tb(s, 0.5, 1.14, 12.4, 0.36,
   ...
   fs=11.5, italic=True, colour=GREY_TEXT)
img_fit(s, "documentation/figures/sf9_literature.png", 0.45, 1.52, 12.45, 3.10)
_lit = {}
...
tb(s, 0.5, 1.16, 12.4, 0.34,
   ...
   fs=11.5, italic=True, colour=GREY_TEXT)
img_fit(s, "documentation/figures/sf9_strain_terms.png", 0.45, 1.52, 12.45, 3.25)
...
sf9_result(211, "CYCLIC — RE-RUN", "T6.4 · T6.5", "documentation/figures/sf9_cyclic_t65.png",
...
tb(s, 0.5, 1.14, 12.4, 0.36,
   ...
   fs=11.5, italic=True, colour=GREY_TEXT)
img_fit(s, "documentation/figures/sf9_t9_baseline.png", 0.45, 1.52, 12.45, 2.95)
...
sf9_result(214, "CREEP — RE-RUN", "T9", "documentation/figures/sf9_creep_t9.png",
...
tb(s, 0.5, 1.14, 12.4, 0.36,
   ...
   fs=11.5, italic=True, colour=GREY_TEXT)
img_fit(s, "documentation/figures/sf9_creep_compare.png", 0.45, 1.52, 12.45, 3.00)
...
#
# Everything on these six pages is recomputed at build time by documentation/scripts/s25_s26_data.py
...
_VC_OVERLAY = VCP.overlay(_os.path.join("documentation", "figures", "s25_s26_overlay.png"))
_VC_ELASTIC = VCP.elastic(_os.path.join("documentation", "figures", "s25_s26_elastic.png"))
...
footer(s, "Both curves come from utm_analysis.analyze() — the same function behind the app's "
          "Generate-report button. Plot: documentation/scripts/s25_s26_plots.py.")
pageno(s)
...
for _i, _chunk in enumerate(_vc_chunks, 1):
    ...
    footer(s, f"Highlighted rows carry MEASURED values at each run's true landmark strain, not "
              ...
              f"documentation/decks/S25_S26_stress_strain_reference.pdf")
    pageno(s)
...
_EF_MECH = EFP.mechanism(_os.path.join("documentation", "figures", "e_fit_mechanism.png"))
_EF_EVID = EFP.evidence(_os.path.join("documentation", "figures", "e_fit_evidence.png"))
_EF_ROWS = EF.table()
...
footer(s, "Rolling fit: 0.20 %-wide window stepped in 0.02 % increments. Markers = centre of each "
          "specimen's steepest straight run. Generated by documentation/scripts/e_fit_plots.py.")
pageno(s)
...
#
# All numbers recomputed at build time by documentation/scripts/s13_data.py; figures by
...
pic_or_ph(s, _os.path.join("documentation", "figures", "s13_solo.png"), 0.35, 1.62, 8.6, 4.83,
          "[ s13_solo.png ]")
...
footer(s, "Generated by documentation/scripts/s13_plots.py from the test CSV. Strain is DIC gauge strain "
...
pic_or_ph(s, _os.path.join("documentation", "figures", "s13_vs_s26.png"), 0.40, 1.80, 12.55, 4.07,
          "[ s13_vs_s26.png ]")
...
pic_or_ph(s, _os.path.join("documentation", "figures", "s13_noise.png"), 0.35, 1.85, 8.5, 3.43,
          "[ s13_noise.png ]")
...
pic_or_ph(s, _os.path.join("documentation", "figures", "s13_coverage.png"), 0.35, 1.62, 8.5, 3.43,
          "[ s13_coverage.png ]")
...
#
# Numbers by documentation/scripts/s27_s28_data.py, figures by s27_s28_plots.py, both at build
...
pic_or_ph(s, _os.path.join("documentation", "figures", "s27_s28_pair.png"), 0.40, 1.85, 12.55, 4.07,
          "[ s27_s28_pair.png ]")
...
tb(s, 0.4, 1.15, 12.55, 0.62,
   ...
   fs=12, italic=True, colour=GREY_TEXT)
pic_or_ph(s, _os.path.join("documentation", "figures", "infill_knockdown.png"), 0.40, 1.85, 12.55, 4.31,
...
pic_or_ph(s, _os.path.join("documentation", "figures", "s27_s28_deviation.png"), 0.40, 1.82, 12.55, 4.22,
...
pic_or_ph(s, _os.path.join("documentation", "figures", "s27_s28_vs_s26.png"), 0.40, 1.82, 12.55, 4.22,
          "[ s27_s28_vs_s26.png ]")
...
img_fit(s, _os.path.join("documentation", "figures", "mot_record.png"), 0.40, 4.32, 12.55, 2.48)
...
img_fit(s, _os.path.join("documentation", "figures", "mot_rate.png"), 0.40, 1.68, 12.55, 3.02)
...
img_fit(s, _os.path.join("documentation", "figures", "mot_noise.png"), 0.40, 1.68, 12.55, 3.02)
...
img_fit(s, _os.path.join("documentation", "figures", "cap_still_formats.png"), 0.40, 1.66, 12.55, 2.62)
...
img_fit(s, _os.path.join("documentation", "figures", "cap_video_codecs.png"), 0.40, 1.62, 12.55, 2.72)
...
img_fit(s, _os.path.join("documentation", "figures", "petg_trio.png"), 1.55, 1.72, 10.0, 3.55)
...
img_fit(s, _os.path.join("documentation", "figures", "petg_limits.png"), 0.40, 1.70, 12.55, 3.15)
...
img_fit(s, _os.path.join("documentation", "figures", "petg_vs_pla.png"), 0.40, 1.62, 12.55, 2.86)
...
img_fit(s, _os.path.join("documentation", "figures", "petg_expect.png"), 0.40, 3.42, 12.55, 2.55)
...
img_fit(s, _os.path.join("documentation", "figures", "petg_plastic.png"), 0.40, 1.64, 12.55, 2.86)
