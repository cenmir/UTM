...
Output: documentation/decks/E_modulus_explained.pptx
"""
import sys
...
sys.path.insert(0, "documentation/scripts")
...
img_fit(s, "documentation/figures/e_fig_riserun.png", 0.35, 1.80, 7.35, 4.55)
...
img_fit(s, "documentation/figures/e_fig_window.png", 0.35, 1.80, 6.15, 4.60)
...
img_fit(s, "documentation/figures/e_fig_two_lines.png", 0.85, 1.72, 11.6, 4.40)
...
img_fit(s, "documentation/figures/e_fig_permanent.png", 0.35, 1.78, 7.55, 4.42)
...
img_fit(s, "documentation/figures/e_fig_bands.png", 0.35, 1.78, 7.55, 4.42)
...
OUT = "documentation/decks/E_modulus_explained.pptx"
prs.save(OUT)
