...
Run from the repo root:  python documentation/v2_capture_plots.py
...
APP = os.path.join(os.path.dirname(ROOT), "Software", "UTM_PyQt6")
...
finish(fig, "v2_capture_timing.png")
...
ax.invert_yaxis()
finish(fig, "v2_capture_sinks.png")
...
ax.set_title("The report's ε_f is the two halves springing apart, not the material stretching",
             fontsize=12.5, fontweight="bold", loc="left")
ax.set_ylim(-4, 52)
finish(fig, "v2_fracture_point.png")
...
ax.set_title("The 80 mm gauge cannot stretch further than the crosshead travelled",
             fontsize=12.5, fontweight="bold", loc="left")
ax.invert_yaxis()
finish(fig, "v2_gauge_impossible.png")
...
ax.set_title("Only the two integrated-to-fracture numbers move. Strength and stiffness stand.",
             fontsize=12.5, fontweight="bold", loc="left")
finish(fig, "v2_kpi_correction.png")
...
finish(fig, "v2_rate_unaffected.png")
