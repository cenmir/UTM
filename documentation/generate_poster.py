"""SMART UTM posters — one content spec, three editions, all written to documentation/posters/.
    ...
    python documentation/generate_poster.py
...
Every number is pulled live from documentation/sf9_data.py (which recomputes it from the rig CSVs) or
...
EVIDENCE = [
    dict(title="Six closed-loop protocols — every trace is real rig data",
         img="documentation/sf9_overview.png",
    ...
    dict(title="The machine reads STIFFER while the specimen SOFTENS",
         img="documentation/sf9_teach_stiffness.png",
    ...
    dict(title="Creep, resolved — and separated from the instrument's own drift",
         img="documentation/sf9_creep_t9.png",
    ...
    dict(title="Where you cycle matters more than how accurately you cycle",
         img="documentation/sf9_cyclic_compare.png",
...
FOOTER = ("Code, raw CSVs and the full 76-slide technical deck: Software/UTM_PyQt6/ and "
          ...
          "documentation/sf9_data.py — none of it is transcribed by hand.  ·  Layout follows the "
...
P_FOOTER = ("Every number on this page is recomputed from the rig CSVs by documentation/sf9_data.py "
...
CUT_DETAIL = "documentation/rig_cut_detail.png"
CUT_FULL = "documentation/rig_cut_full.png"
SCHEMATIC = "documentation/rig_schematic.png"
