"""Background-removed cutouts of the 2026-08-12 rig photographs, for the posters.
    ...
    python documentation/rig_cutouts.py
...
SOURCES = [
    ...
    ("UTM rig_12-08-26.jpg",     "rig_cut_full.png",   None),
    ("UTM rig_12-08-26 (1).jpg", "rig_cut_detail.png", None),
]
...
def cutout(src, dst, precrop=None, pad=8):
    ...
    im = Image.open(os.path.join(_HERE, src)).convert("RGB")
    if precrop:
        W, H = im.size
        l, t, r, b = precrop
    ...
    img.save(os.path.join(_HERE, dst))
